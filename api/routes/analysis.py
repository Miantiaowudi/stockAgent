...
from workflows.stock_analysis import run_stock_analysis
...
async def batch_analyze(request: BatchAnalysisRequest):
    ...
    for stock_code in request.stocks:
        try:
            result = await run_stock_analysis(stock_code=stock_code)
